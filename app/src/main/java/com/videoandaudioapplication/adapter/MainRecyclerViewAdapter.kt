package com.videoandaudioapplication.adapter
...
import com.videoandaudioapplication.databinding.ItemMainRecyclerViewBinding
 ...
 */
class MainRecyclerViewAdapter(private val audioVideoClickListener: AudioVideoClickListener) : RecyclerView.Adapter<MainRecyclerViewAdapter.MainRecyclerViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MainRecyclerViewHolder, position: Int) {
        usersList?.let { list->
            ...
            holder.bind(user,{
                audioVideoClickListener.onVideoCallClicked(it)
            },{
                audioVideoClickListener.onAudioCallClicked(it)
            })
        }
    }
